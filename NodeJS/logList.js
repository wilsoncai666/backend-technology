const logList = {
    ...
    '131F': {
        ...
        yKeyArr: [
            {key: 'kickDown', ratio: 1, unit: "s"},
        ],
        Purpose: 'To register the usage of the automatic and the manual kick down functionality.',
        Informant: '',
        SYSDATALevel: '6',
        MethodOfMeasurement: 'Incremental',
        InputSignal: 'Engine running\n' +
            'Status automatic kick down\n' +
            'Status manual kick down',
        Filtering: 'None',
        ActionsAtInputSignalError: 'No logging shall be performed if the signal is erroneous.',
        SamplingRate: '1Hz',
        Hz: 1,
        BitResolution: 'Cell nr 1 and 3: 1 bit = 1 s \n' +
            'Cell nr 2 and 4: 1 bit = 1 registration',
        BitA: 1,
        BitAUnit: 's',
        BitB: '10',
        BitBUnit: 's',
        ConditionsForLogging: 'Engine running (all cells)\n' +
            'Automatic kick down function activated: Cell no 3',
        OutputDataFormat: ''
    },
    '130F': {
        id: '130F',
        ...
        yKeyArr: [
            {key: 'no', ratio: 1, unit: "registration"},
            {key: 'time', ratio: 1, unit: "s"},
        ],
        Purpose: 'To register the usage of the transmission APS.',
        Informant: '',
        SYSDATALevel: '6',
        MethodOfMeasurement: 'Incremental',
        InputSignal: 'Engine running\n' +
            'Status APS selector (transmission APS)',
        Filtering: 'None',
        ActionsAtInputSignalError: 'No logging shall be performed if the signal is erroneous.',
        SamplingRate: '1Hz',
        Hz: 1,
        BitResolution: 'Cell nr 1 and 7-11: 1 bit = 1 s\n' +
            'Cell nr 2-6: 1 bit = 1 registration',
        BitA: 1,
        BitAUnit: 's',
        BitB: '10',
        BitBUnit: 's',
        ConditionsForLogging: 'All cells: Engine running\n' +
            'Cell no 2-6: To register one activation of the APS the activation time must exceed 1 s.',
        OutputDataFormat: ''
    },
    '1318': {
        id: '1318',
        ...
        yKeyArr: [
            {key: 'temp', ratio: 10, unit: "s"},
        ],
        Purpose: 'To get information about the transmission oil temperature distribution to be able to estimate the oil decomposition level and in the long term be able to predict the oil change interval. Also used for performance calculation and for calculating temperature compensated duty values for sizing of the transmissions components. ',
        Informant: 'Mikael Petersson',
        SYSDATALevel: '6',
        MethodOfMeasurement: 'Incremental',
        InputSignal: 'Engine on\n' +
            ...
            'Machine Time',
        Filtering: 'None',
        ActionsAtInputSignalError: 'No logging shall be performed if any of the input signals is erroneous.',
        SamplingRate: '0.1Hz',
        Hz: 0.1,
        BitResolution: 'Cell no 1: 1 s\n' +
            'Cell no 2-13: 10 s',
        BitA: 1,
        BitAUnit: 's',
        BitB: '10',
    ...
    '1319': {
        ...
        Purpose: 'Registration of the time spent at each gear, separated on converter resp lock up usage. To be used as input e.g. for design of transmissions etc.',
        Informant: 'TUT-18, Lena Brattberg Norman, +46 16 151895',
        SYSDATALevel: '6',
        MethodOfMeasurement: 'Incremental',
        InputSignal: 'Engine running \n' +
            'Engaged gear\n' +
        ...
        BitBUnit: 's',
        ConditionsForLogging: '',
        OutputDataFormat: 'C = converter \tLU = lock up'
    },
    '131A': {
        id: '131A',
        demo: null,
        ...
        yKeyArr: [
            ...
            {key: 'bt31p5n36', ratio: 1, unit: "s"},
            {key: 'bt36n40p5', ratio: 1, unit: "s"},
            {key: 'gte40p5', ratio: 1, unit: "s"},
        ],
        Purpose: 'To earn knowledge about frequency and machine and engine speed distribution while shifting from reverse to forward gears.',
        Informant: 'TUT-18, Lena Brattberg Norman, +46 16 151895',
        SYSDATALevel: '6',
        MethodOfMeasurement: 'Incremental',
        InputSignal: 'Engine running\n' +
        ...
        SamplingRate: '10Hz',
        Hz: 1,
        BitResolution: 'Cell no 1: \t\t1 bit = 1 s\n' +
            'Cell no 2-41:\t1 bit = 1 gear shift R→F',
        BitA: 1,
        BitAUnit: 's',
        BitB: '10',
        BitBUnit: 's',
        ConditionsForLogging: 'Engine running.\n' +
            'Gear N for maximum 1 s while reversing\n' +
            'Engine and machine speed shall be measured when the lever for directional change is moved from R to F.',
        OutputDataFormat: ''
    },
    '131B': {
        id: '131B',
        ...
        Purpose: 'To earn knowledge about frequency and machine and engine speed distribution while shifting from forward to reverse gears.',
        Informant: 'TUT-18, Lena Brattberg Norman, +46 16 151895',
        SYSDATALevel: '6',
        MethodOfMeasurement: 'Incremental',
        InputSignal: 'Engine running\n' +
        ...
        Hz: 1,
        BitResolution: 'Cell no 1: \t\t1 bit = 1 s\n' +
            'Cell no 2-41:\t1 bit = 1 gear shift F→R',
        BitA: 1,
        BitAUnit: 's',
        BitB: '10',
        BitBUnit: 's',
        ConditionsForLogging: 'Engine running.\n' +
            'Gear N for maximum 1 s while reversing\n' +
            'Engine and machine speed shall be measured when the lever for directional change is moved from F to R. ',
        OutputDataFormat: 'In cell no (1) the total log duration shall be stored (1 bit = 1 s).\n' +
            'Matrix with number of F→R gear shifts in each engine and machine speed class.'
    },
    '12F0': {
        id: '12F0',
        demo: null,
        ...
        yKeyArr: [
            {key: 'fw', ratio: 1, unit: "s"},
            {key: 'bw', ratio: 1, unit: "s"},
        ],
        Purpose: 'Register information about how intense the brakes are used to be able to calculate collective of brake torque for lifetime judgment of disk splines among other things.',
        Informant: 'TUD, Magnus Engman',
        SYSDATALevel: '6',
        MethodOfMeasurement: 'Incremental',
        InputSignal: 'Pressure in brake circuit.\n' +
            'Used directional gear (forward/backward) when the brake operation is started\n' +
            'Engine running',
        Filtering: 'None',
        ActionsAtInputSignalError: 'No logging shall be performed if any signal is erroneous.',
        SamplingRate: '10Hz',
        Hz: 10,
        BitResolution: 'Cell 1: 1 bit = 1s.\n' +
            'Cell 2-27: 1 bit = number of brake operations',
        BitA: 1,
        BitAUnit: 's',
        BitB: '10',
        BitBUnit: 's',
        ConditionsForLogging: 'Brake operation: The pressure should change from < 5 bar to higher pressure and back to < 5 bar. The highest value during the cycle is saved.',
        OutputDataFormat: 'Data is stored in a vector with 27 cells, see below.\n' +
            'Log duration is stored in first cell. \n' +
            'Number of brake operations with forward gear activated is stored per pressure class in cell 2-14. ' +
            'Number of brake operations with backward gear activated is stored per pressure class in cell 15-27.'
    },
    ...
    '1309': {
        ...
        yKeyArr: [
            {key: 'lowLim', ratio: 10, unit: "s"},
        ],
        Purpose: 'Register information about the front axle temperature, to be able to find possible abnormal conditions and to assess the oils degradation.',
        Informant: '',
        SYSDATALevel: '6',
        MethodOfMeasurement: 'Incremental',
        InputSignal: 'Temperature front axle, analogue sensor\n' +
            'Diesel engine running',
        Filtering: 'None',
        ActionsAtInputSignalError: 'No logging shall be performed if any signal is erroneous.',
        SamplingRate: '0.1Hz',
        Hz: 1,
        BitResolution: 'Cell 1: 1 bit = 1 second.\n' +
            'Cell 2-13: 1 bit = 10 second.',
        BitA: 1,
        BitAUnit: 's',
        BitB: '10',
        BitBUnit: 's',
        ConditionsForLogging: 'Diesel engine must run.',
        OutputDataFormat: 'Data is stored in a vector with 13 cells, see below.\n' +
            'Log duration is stored in first cell. \n' +
            'The time within a specified temperature interval is stored in cell 2-13. '
    },
    '130C': {
        id: '130C',
        demo: null,
        ...
        Purpose: 'Register information about the rear axle temperature, to be able to find possible abnormal conditions and to assess the oils degradation.',
        Informant: 'TUD, Tord Dahlén',
        SYSDATALevel: '6',
        MethodOfMeasurement: 'Incremental',
        InputSignal: 'Temperature rear axle, analogue sensor\n' +
            'Diesel engine running',
        Filtering: 'None',
        ActionsAtInputSignalError: 'No logging shall be performed if any signal is erroneous.',
        SamplingRate: '0.1Hz',
    ...
    '1315': {
        ...
        yKeyArr: [
            {key: 'macSpd', ratio: 1, unit: "s"},
        ],
        Purpose: 'Specify data related to differential lock vs machine speed that is logged.',
        Informant: '',
        SYSDATALevel: '6',
        MethodOfMeasurement: 'Incremental',
        InputSignal: 'Engine State {Off, Crank, On}\t\n' +
            'Differential lock Status {Engaged, Disengaged}\t\n' +
            'Machine Speed {km/h}',
        Filtering: 'None',
        ActionsAtInputSignalError: 'Engine State {Off, Crank, On}\tno data logging\t\n' +
            'Differential Lock Status\tno data logging\n' +
            'Machine Speed\tno data logging',
        SamplingRate: '1Hz',
        Hz: 1,
        BitResolution: 'For cells 1 and 2, 1 bit = 1 second,\n' +
            'For all other cells, 1 bit = 1 occurrence.',
        BitA: 1,
        BitAUnit: 's',
        BitB: '10',
        BitBUnit: 's',
        ConditionsForLogging: 'Engine state must be “on” for logging in any of the cells to occur.\n' +
            'Time is logged in cell 2 when the differential lock status is “engaged.”  In order for a differential lock engage to be recognized and the count to increment by 1, the differential lock status must change from “disengaged” or “error” to “engaged.”  For all cells except cells 1 and 2, the machine must be travelling at the corresponding speed for data to be logged.',
        OutputDataFormat: 'Output is stored in a vector containing the number of differential lock engagements in each speed interval.\n' +
            'In cell 2 the total cumulative time the differential lock has been engaged is stored.\n' +
            'In cell 1 information of total log duration is stored.'
    },
    '12EE': {
        id: '12EE',
        ...
        yKeyArr: [
            {key: 'bet0n46400', ratio: 1, unit: "num"},
            {key: 'bet46400n100000', ratio: 1, unit: "num"},
            {key: 'bet100000n215000', ratio: 1, unit: "num"},
            {key: 'bet215000n464000', ratio: 1, unit: "num"},
            {key: 'bet464000n1000000', ratio: 1, unit: "num"},
            {key: 'bet1000000n2150000', ratio: 1, unit: "num"},
            {key: 'bet2150000n4640000', ratio: 1, unit: "num"},
            {key: 'bet4640000n10000000', ratio: 1, unit: "num"},
            {key: 'bet10000000n21500000', ratio: 1, unit: "num"},
            {key: 'gte21500000', ratio: 1, unit: "num"},
        ],
        Purpose: 'Use together with Log ID 374 to obtain information about the brake energy. With this information it is possible to calculate temperature in brake, and theoretically life remaining for the brake discs and sealings.',
        Informant: 'TUT10  Tord Dahlén,  KD3  Karl Erik Olsson',
        SYSDATALevel: '6',
        MethodOfMeasurement: 'Incremental',
        InputSignal: 'Vehicle speed, v\t\t[km/h]\n' +
            'Pressure in brake circuit, p\t[bar]\n' +
            'Engine running',
        Filtering: 'None',
        ActionsAtInputSignalError: 'No logging shall be performed if any signal is erroneous.',
        SamplingRate: '10Hz',
        Hz: 10,
        BitResolution: 'Cell 1: Bit 1 = 1 s\n' +
            'Cell 2-101: Bit 1 = number of brakings',
        BitA: 1,
        BitAUnit: 's',
        BitB: '10',
        BitBUnit: 's',
        ConditionsForLogging: 'Pressure in brake circuit has to be > 5.0 bar, and Vehicle speed has to be > 2.5 km/h\n' +
            '\n' +
            'Definition of braking:\n' +
            'Pressure in brake circuit changes from < 5.0 [bar] to > 5.0 [bar] and then back to < 5.0 [bar].\n' +
            '\n' +
            'Brake energy calculation:\n' +
            'Energy, E = p[bar] * v[km/h] * time[100 ms]\n' +
            'Temperature raise, ΔT² = E²/t.',
        OutputDataFormat: 'Number of brakings is distributed between cell 2-101 according to the duration of the braking (columns) and the temperature raise during the brake (rows).\n' +
            'In cell no. 1 the duration of the log should be stored.'
    },
    '1317': {
        id: '1317',
        ...
        Purpose: 'Specify data relating to high transmission oil temperature instances that is logged.',
        Informant: 'Log has common duration log format and is intended for use by all VCE business lines.  See general log requirements document for details.',
        SYSDATALevel: '6',
        MethodOfMeasurement: 'Duration',
        InputSignal: 'Engine state {Off, On}\t\n' +
            'Transmission Temperature {Temperature in ºC, Error}\t\n' +
            'Transmission Oil Temperature Status {Normal, High, Error}\t\n' +
            'Date\n' +
            'Time\n' +
            'Machine time',
        Filtering: 'Duration filter of 60 seconds used for all logged data.',
        ActionsAtInputSignalError: 'Bit resolutions are of standard duration log format.\n' +
            'For temperature values, 1 bit = 1 ºC.',
        SamplingRate: '1Hz',
        Hz: 1,
        BitResolution: '',
        ...
        events: 20,
        optional: 0,
        ConditionsForLogging: 'Engine state must be “on” for logging in any of the cells or data points.\n' +
            'Transmission oil temperature status must also be “high” for time to be logged in cell 3.  In order for an occurrence of high oil temperature to be recorded in a data point and the count to increment by 1, the high transmission oil temperature state must change from “normal” or “error” to “high.”  The event of high transmission oil temperature will end when the status changes from “high” back to “normal” or “error.”  The high transmission oil temperature value will record the highest temperature reached over the duration of the logged event.',
        OutputDataFormat: 'Bit resolutions are of standard duration log format.\n' +
            'For temperature values, 1 bit = 1 ºC.'
    },
    '1316': {
        id: '1316',
        ...
        yKeyArr: [
            {key: 'Kab', ratio: 0.1, unit: "bar"},
        ],
        Purpose: 'Specify data relating to low transmission oil pressure instances that is logged.',
        Informant: 'Log has common duration log format and is intended for use by all VCE business lines.',
        SYSDATALevel: '6',
        MethodOfMeasurement: 'Duration',
        InputSignal: 'Engine state\t\n' +
            'Transmission oil pressure\t\n' +
            'Transmission oil pressure level low\t\n' +
            'Date\n' +
            'Time\n' +
            'Machine time',
        Filtering: 'Duration filter of 60 seconds used for all logged data.',
        ActionsAtInputSignalError: 'Engine state\tno data logging\n' +
            'Transmission pressure\tno data logging\n' +
            'Transmission oil pressure status\tno data logging',
        SamplingRate: '1Hz',
        Hz: 1,
        BitResolution: 'Bit resolutions are of standard duration log format.\n' +
            'For pressure values, 1 bit = 0.1 bar.',
        BitA: 1,
        BitAUnit: 's',
        BitB: '10',
        BitBUnit: 's',
        ...
        optional: 0,
        ConditionsForLogging: 'Engine state must be “on” for logging in any of the cells or range pairs.\n' +
            'Transmission oil pressure status must also be low for time to be logged in cell 3.  In order for an occurrence of low transmission oil pressure to be recorded in a data point and the count to increment by 1, the transmission oil pressure state must change from “normal” or “error” to “low.”  The event of low transmission oil pressure will end when the status changes from “low” back to “normal” or “error.”  The low transmission oil pressure value will record the lowest pressure reached over the duration of the logged event.',
        OutputDataFormat: ''
    },
    '1576': {
        id: '1576',
        ...
        Purpose: 'To store data about how often the parking brake has been applied.',
        Informant: '',
        SYSDATALevel: '6',
        MethodOfMeasurement: 'Duration',
        InputSignal: 'Engine running\t[ON, OFF]\n' +
            'Parking brake applied\t[ON, OFF]',
        Filtering: 'None',
        ActionsAtInputSignalError: 'No logging should be performed if any input signal is erroneous.',
        SamplingRate: '1Hz',
        Hz: 1,
        ...
        events: 20,
        optional: 0,
        ConditionsForLogging: 'Logging should be performed when Parking brake applied is [ON] and Engine running is [ON].',
        OutputDataFormat: 'See document General log requirements. The data shall be stored as a duration log with 20 events and shall use a 60 s duration filter. No optional data shall be stored.'
    },
    '1578': {
        id: '1578',
        demo: null,
        ...
        Purpose: 'Show information of parking brake abuse. The 20 last occurrences of parking abuse should be shown.',
        Informant: 'Fredrik Mirhag, TUE ',
        SYSDATALevel: '6',
        MethodOfMeasurement: 'Duration',
        InputSignal: 'Vehicle speed\t\n' +
            'Actual gear\t\n' +
            'Parking brake applied \t[True, False]\n' +
            'Engine running\n' +
            'Date\n' +
            'Time\n' +
            'Machine time',
        ...
        events: 20,
        optional: 0,
        ConditionsForLogging: 'Vehicle speed exceeds 3 km/h.\n' +
            'Parking brake applied is [True]' +
            'Actual gear is not [N]',
        OutputDataFormat: 'See document General log requirements. The data shall be stored as a duration log with 20 events and shall use a 60 s duration filter.'
    },
